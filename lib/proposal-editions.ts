...
const editions: Record<ProposalNiche, Edition[]> = {
  ...
  Design: [
    ...
    ['tipografia', 'Tipo & personalidade', 'Uma voz que se vê.', 'Sistema visual tipográfico', 'Pesquisa de expressão visual|Direção tipográfica|Sistema de composição|Guia de uso e cinco aplicações', 'Dar personalidade à comunicação por meio de tipografia, composição e hierarquia.', 16000],
