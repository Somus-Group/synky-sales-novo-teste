...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font-family:Inter,Arial,Helvetica,sans-serif;font-size:16px;line-height:1.6}a{color:inherit}header{max-width:1280px;margin:auto;padding:24px 40px;display:flex;align-items:center;justify-content:space-between;gap:28px}header img{display:block;width:auto;max-width:190px;max-height:58px;object-fit:contain}header strong{font-size:18px}nav{display:flex;gap:18px;flex-wrap:wrap}nav a{font-size:13px;font-weight:700;text-decoration:none;opacity:.68}nav a:hover{opacity:1}.hero{background:var(--ink);color:#fff;padding:28px 40px 40px}.hero-shell,.container{max-width:1200px;margin:auto}.hero-shell{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(310px,.8fr);gap:54px;align-items:end;padding:70px 0 46px}.eyebrow,.section-label{display:flex;align-items:center;gap:9px;color:var(--accent);font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.eyebrow{color:#fff}.eyebrow:before{content:'';width:7px;height:7px;background:var(--accent);border-radius:50%}h1,h2,p{margin:0}h1{max-width:800px;margin:20px 0 22px;font-size:clamp(44px,6vw,84px);line-height:.99;letter-spacing:0}.hero-copy>p{max-width:650px;color:#e9edf4;font-size:20px}.hero-panel{padding:28px;background:var(--surface);color:var(--ink);border-radius:8px}.hero-panel>span{display:block;font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.hero-panel>strong{display:block;margin:42px 0 30px;font-size:clamp(24px,3vw,42px);line-height:1.05}.signals{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;padding-top:20px;border-top:1px solid var(--line)}.signals strong,.signals span{display:block}.signals strong{font-size:23px;line-height:1}.signals span{margin-top:6px;font-size:11px;line-height:1.35}.section{padding:96px 40px}.split{display:grid;grid-template-columns:.85fr 1.15fr;gap:80px;align-items:start}h2{font-size:clamp(30px,3.2vw,48px);line-height:1.05;margin:18px 0}.lead{font-size:21px;line-height:1.55}.scope-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;background:var(--line);border:1px solid var(--line)}.scope-card{min-height:180px;padding:23px;background:var(--paper)}.scope-card span{color:var(--accent);font-size:12px;font-weight:800;letter-spacing:.08em}.scope-card p{margin-top:34px;font-size:17px;font-weight:650;line-height:1.4}.method{background:var(--surface);padding:92px 40px}.method .container{display:grid;grid-template-columns:.85fr 1.15fr;gap:80px;align-items:start}.method h2{max-width:470px}.method-list,.timeline{margin:0;padding:0;list-style:none}.method-list{display:grid;gap:0}.method-step{display:grid;grid-template-columns:52px 1fr;gap:18px;padding:20px 0;border-top:1px solid var(--line)}.method-step span{display:grid;place-items:center;width:36px;height:36px;border:1px solid var(--accent);color:var(--accent);font-size:11px;font-weight:800}.method-step p{font-size:17px;font-weight:650}.timeline-section{background:#fff}.timeline{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;margin-top:42px}.timeline-item{padding:22px 0;border-top:2px solid var(--accent)}.timeline-item span{display:block;color:var(--accent);font-size:12px;font-weight:800}.timeline-item p{margin-top:16px;font-size:17px;font-weight:650;line-height:1.4}.investment-section{padding:40px;background:var(--ink);color:#fff}.investment-grid{max-width:1200px;margin:auto;display:grid;grid-template-columns:.9fr 1.1fr;gap:60px;align-items:end;padding:52px 0}.investment-grid .section-label{color:var(--accent)}.investment-grid h2{max-width:500px}.investment-card{padding:30px;border:1px solid #ffffff4d;background:#ffffff0d}.investment-card span{display:block;color:#ffffffb8;font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.investment-card p{margin-top:16px;font-size:clamp(24px,3vw,39px);font-weight:700;line-height:1.12}.next{padding:96px 40px;background:var(--paper)}.next-grid{max-width:1200px;margin:auto;display:grid;grid-template-columns:.85fr 1.15fr;gap:80px}.next-list{display:grid;gap:0;margin:0;padding:0;list-style:none;border-top:1px solid var(--line)}.next-list li{display:grid;grid-template-columns:34px 1fr;gap:14px;padding:16px 0;border-bottom:1px solid var(--line)}.next-list span{color:var(--accent);font-size:12px;font-weight:800}.next-list p{font-size:16px;font-weight:650}.footer{max-width:1200px;margin:auto;padding:28px 40px;border-top:1px solid var(--line);color:color-mix(in srgb,var(--ink) 58%,transparent);font-size:13px}.editorial h1,.editorial h2{font-family:Georgia,'Times New Roman',serif}.editorial .hero{background:var(--surface);color:var(--ink)}.editorial .hero-copy>p{color:color-mix(in srgb,var(--ink) 72%,transparent)}.editorial .hero-panel{background:var(--ink);color:#fff}.editorial .eyebrow{color:var(--ink)}.bold h1{max-width:900px;font-size:clamp(54px,7vw,98px)}.minimal .hero-shell{padding-top:42px}.dark{--paper:#11151d;--line:#ffffff2c;background:#11151d;color:#f3f5f8}.dark header{background:#11151d}.dark .hero{background:#07090d}.dark .hero-panel{background:var(--surface)}.dark .scope-card,.dark .timeline-section{background:#171c25}.dark .method{background:#202732}.dark .next{background:#11151d}.dark .footer{color:#ffffffa8}.dark .hero-copy>p{color:#d7dce5}@media(max-width:760px){header,.hero,.section,.method,.investment-section,.next{padding-left:22px;padding-right:22px}header{align-items:flex-start;flex-direction:column;padding-top:20px;padding-bottom:20px}.hero-shell,.split,.method .container,.investment-grid,.next-grid{grid-template-columns:1fr;gap:38px;padding-top:42px}.scope-grid,.timeline{grid-template-columns:1fr}.section,.method,.next{padding-top:62px;padding-bottom:62px}.hero-panel>strong{margin:28px 0}.hero-copy>p,.lead{font-size:18px}.timeline{margin-top:28px}.signals{gap:8px}.investment-grid{padding:26px 0}.investment-card{padding:24px}nav{gap:14px}}
    /* Proposal website skin: keeps generated Studio work out of a PDF layout. */
    body.proposal{background:#f4f8fa;color:#15283b}.proposal header{position:sticky;top:0;z-index:10;max-width:none;padding:18px max(28px,calc((100vw - 1200px)/2));background:#ffffffea;border-bottom:1px solid #d9e6eb;backdrop-filter:blur(14px)}.proposal nav a{padding:8px 11px;border-radius:999px;color:#496175;opacity:1}.proposal nav a:hover{background:#e4f2f3;color:#116d73}.proposal .hero{padding:0 40px;background:var(--surface);color:#15283b}.proposal .hero-shell{grid-template-columns:minmax(0,1fr) minmax(240px,.55fr);min-height:600px;align-items:center;padding:88px 0}.proposal .eyebrow{color:#116d73}.proposal .hero h1{font-family:Inter,Arial,Helvetica,sans-serif;font-size:clamp(50px,7vw,92px);line-height:.96}.proposal .hero-copy>p{color:#50687a}.proposal .hero-panel{border-left:4px solid var(--accent);border-radius:10px;background:#fff;color:#15283b;box-shadow:0 20px 42px #1b435318}.proposal .scope-grid{gap:14px;border:0;background:none}.proposal .scope-card{min-height:200px;border:1px solid #dce7eb;border-radius:12px;background:#fff;transition:transform .2s ease,box-shadow .2s ease}.proposal .scope-card:hover{transform:translateY(-5px);box-shadow:0 16px 28px #1b435318}.proposal .method{background:#e9f3f4}.proposal .timeline-section{background:#fff}.proposal .investment-section{background:#153f63}.proposal .next{background:#f4f8fa}.proposal .footer{max-width:none;padding:28px max(28px,calc((100vw - 1200px)/2));border:0;background:#153f63;color:#d7e9f1}.proposal .section-label{color:#116d73}.proposal .investment-grid .section-label{color:#aee9d3}.proposal .investment-card{border-radius:12px;background:#ffffff10}.proposal .next-list li{padding:20px 0}.proposal .next-list span{color:#e56f55}@media(max-width:760px){.proposal header,.proposal .hero,.proposal .section,.proposal .method,.proposal .investment-section,.proposal .next{padding-left:22px;padding-right:22px}.proposal .hero-shell{grid-template-columns:1fr;min-height:0;padding:62px 0}.proposal .hero h1{font-size:52px}.proposal .hero-panel{margin-top:8px}}
    /* Final Studio composition: a project canvas rather than a report. */
    body.proposal{background:#f4f7fb;color:#13263d}.proposal header{position:sticky;top:0;z-index:10;max-width:none;padding:15px max(28px,calc((100vw - 1200px)/2));background:#ffffffd9;border-bottom:1px solid #dce6ee;backdrop-filter:blur(18px)}.proposal nav{gap:4px}.proposal nav a{padding:8px 11px;border-radius:9px;color:#486176;opacity:1}.proposal nav a:hover{background:var(--soft);color:var(--accent)}.proposal .hero{position:relative;overflow:hidden;padding:0 40px;background:#102642;color:#fff}.proposal .hero:after{content:'';position:absolute;right:-10vw;top:-15vw;width:44vw;height:44vw;border:1px solid #ffffff2c;border-radius:50%;box-shadow:0 0 0 50px #ffffff08,0 0 0 100px #ffffff06}.proposal .hero-shell{position:relative;z-index:1;grid-template-columns:minmax(0,1fr) minmax(260px,.52fr);min-height:660px;align-items:end;padding:120px 0 64px}.proposal .eyebrow{color:#cbe9ff}.proposal .hero h1{font-family:Inter,Arial,Helvetica,sans-serif;font-size:clamp(52px,7vw,96px);line-height:.94}.proposal .hero-copy>p{color:#d7e5f1}.proposal .hero-panel{padding:25px;border:1px solid #ffffff44;border-radius:16px;background:#ffffff10;color:#fff;box-shadow:inset 0 1px #ffffff24;backdrop-filter:blur(14px)}.proposal .signals{border-color:#ffffff33}.proposal .scope-grid{gap:14px;border:0;background:none}.proposal .scope-card{min-height:220px;border:1px solid #dce7ee;border-radius:14px;background:#fff;box-shadow:0 10px 22px #1738520d;transition:transform .2s ease,box-shadow .2s ease}.proposal .scope-card:nth-child(3n+2){background:color-mix(in srgb,var(--accent) 8%,white)}.proposal .scope-card:hover{transform:translateY(-6px);box-shadow:0 20px 34px #17385220}.proposal .method{background:var(--surface)}.proposal .method-step{padding:24px 0}.proposal .timeline-section{background:#fff}.proposal .timeline-item{border-width:3px}.proposal .investment-section{background:#f0bc61;color:#17263b}.proposal .investment-grid .section-label{color:#654500}.proposal .investment-card{border:1px solid #87631f44;border-radius:14px;background:#fff5df;color:#17263b}.proposal .investment-card span{color:#74551e}.proposal .next{background:#102642;color:#fff}.proposal .next .section-label{color:#a8efd0}.proposal .next-list{border-color:#ffffff35}.proposal .next-list li{padding:20px 0;border-color:#ffffff27}.proposal .next-list p{color:#e9f3fb}.proposal .next-list span{color:#a8efd0}.proposal .footer{max-width:none;padding:28px max(28px,calc((100vw - 1200px)/2));border:0;background:#102642;color:#b9cfdf}@media(max-width:760px){.proposal header,.proposal .hero,.proposal .section,.proposal .method,.proposal .investment-section,.proposal .next{padding-left:22px;padding-right:22px}.proposal .hero-shell{grid-template-columns:1fr;min-height:0;padding:110px 0 46px}.proposal .hero h1{font-size:52px}.proposal .hero-panel{margin-top:8px}}
  </style>
</head>
<body class="proposal ${template.layout}">
  ...
  <main>
    <section class="hero"><div class="hero-shell"><div class="hero-copy"><span class="eyebrow">Projeto em conversa</span><h1>${escapeHtml(content.headline)}</h1><p>${escapeHtml(content.summary)}</p></div><aside class="hero-panel"><span>Em uma frase</span><strong>${escapeHtml(content.title)}</strong><div class="signals">${signalItems}</div></aside></div></section>
    <section class="section" id="escopo"><div class="container split"><div><span class="section-label">Ponto de partida</span><h2>O que este projeto precisa destravar.</h2><p class="lead">${escapeHtml(content.objective)}</p></div><div><span class="section-label">Módulos da entrega</span><div class="scope-grid">${scopeCards(content.scope)}</div></div></div></section>
    <section class="method" id="metodo"><div class="container"><div><span class="section-label">Ritmo de trabalho</span><h2>Como a parceria ganha corpo.</h2></div><ol class="method-list">${numberedList(content.method, 'method-step')}</ol></div></section>
    <section class="section timeline-section"><div class="container"><span class="section-label">Mapa de execução</span><h2>Os marcos que dão direção.</h2><ol class="timeline">${numberedList(content.timeline, 'timeline-item')}</ol></div></section>
    <section class="investment-section" id="investimento"><div class="investment-grid"><div><span class="section-label">Investimento</span><h2>O investimento para colocar o plano em movimento.</h2></div><aside class="investment-card"><span>Condições comerciais</span><p>${escapeHtml(content.investment)}</p></aside></div></section>
    <section class="next" id="proximos-passos"><div class="next-grid"><div><span class="section-label">Continuidade</span><h2>O próximo movimento começa aqui.</h2></div><ol class="next-list">${numberedList(content.nextSteps, 'next-item')}</ol></div></section>
  </main>
