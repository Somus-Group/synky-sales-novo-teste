...
export const studioWebInstructions = [
  'Organize uma proposta comercial em português do Brasil. Retorne somente dados do schema; o sistema monta a página web, imagens e totais. Não escreva HTML, CSS ou markdown.',
